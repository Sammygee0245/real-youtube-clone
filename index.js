...
mainsearch.addEventListener("click", () => {
  ...
  if (inputfeild.value == "") {
    ...
    async function youtube() {
      ...
      let chanelpic1 = document.querySelector(".chp-1");
      ...
      let chanelpic2 = document.querySelector(".chp-2");
      ...
      let chanelpic3 = document.querySelector(".chp-3");
      ...
      let chanelpic4 = document.querySelector(".chp-4");
      ...
      let chanelpic5 = document.querySelector(".chp-5");
      ...
      let chanelpic6 = document.querySelector(".chp-6");
      ...
      let chanelpic7 = document.querySelector(".chp-7");
      ...
      let chanelpic8 = document.querySelector(".chp-8");
      ...
      let chanelpic9 = document.querySelector(".chp-9");
      ...
      let chanelpic10 = document.querySelector(".chp-10");
      ...
      let chanelpic11 = document.querySelector(".chp-11");
      ...
      let chanelpic12 = document.querySelector(".chp-12");
      ...
      let chanelpic13 = document.querySelector(".chp-13");
      ...
      let chanelpic14 = document.querySelector(".chp-14");
      ...
      let chanelpic15 = document.querySelector(".chp-15");
      ...
      let chanelpic16 = document.querySelector(".chp-16");
      ...
      let chanelpic17 = document.querySelector(".chp-17");
      ...
      let chanelpic18 = document.querySelector(".chp-18");
      ...
      let chanelpic19 = document.querySelector(".chp-19");
      ...
      let chanelpic20 = document.querySelector(".chp-20");
      ...
      let chanelpic21 = document.querySelector(".chp-21");
      ...
      let chanelpic22 = document.querySelector(".chp-22");
      ...
      let chanelpic23 = document.querySelector(".chp-23");
      ...
      let chp = channelp.items.map((ch) => {
        return ch.snippet.thumbnails.medium;
      });
      ...
      chanelpic1.setAttribute("src", chp[0].url);
      ...
      chanelpic2.setAttribute("src", chp[1].url);
      ...
      chanelpic3.setAttribute("src", chp[2].url);
      ...
      chanelpic4.setAttribute("src", chp[3].url);
      ...
      chanelpic5.setAttribute("src", chp[4].url);
      ...
      chanelpic6.setAttribute("src", chp[5].url);
      ...
      chanelpic7.setAttribute("src", chp[6].url);
      ...
      chanelpic8.setAttribute("src", chp[7].url);
      ...
      chanelpic9.setAttribute("src", chp[8].url);
      ...
      chanelpic10.setAttribute("src", chp[9].url);
      ...
      chanelpic11.setAttribute("src", chp[10].url);
      ...
      chanelpic12.setAttribute("src", chp[11].url);
      ...
      chanelpic13.setAttribute("src", chp[12].url);
      ...
      chanelpic14.setAttribute("src", chp[13].url);
      ...
      chanelpic15.setAttribute("src", chp[14].url);
      ...
      chanelpic16.setAttribute("src", chp[15].url);
      ...
      chanelpic17.setAttribute("src", chp[16].url);
      ...
      chanelpic18.setAttribute("src", chp[17].url);
      ...
      chanelpic19.setAttribute("src", chp[18].url);
      ...
      chanelpic20.setAttribute("src", chp[19].url);
      ...
      chanelpic21.setAttribute("src", chp[20].url);
      ...
      chanelpic22.setAttribute("src", chp[21].url);
      ...
      chanelpic23.setAttribute("src", chp[22].url);
      ...
      chanelpic24.setAttribute("src", chp[22].url);
...
async function youtube() {
  ...
  let response = await fetch(
    "https://youtube.googleapis.com/youtube/v3/search?part=snippet&q=cat&type=video&key=AIzaSyCk7xTmPnD7dEgi7j2S2d8xNeWCgi9CqCI&maxResults=24"
  );
  let youtubedata = await response.json();
  ...
  let channepic = await fetch(
    "https://youtube.googleapis.com/youtube/v3/channels?part=snippet&id=" +
      chanelid +
      "&key=AIzaSyCk7xTmPnD7dEgi7j2S2d8xNeWCgi9CqCI&maxResults=24"
  );

  let channelp = await channepic.json();

  let chp = channelp.items.map((ch) => {
    return ch.snippet.thumbnails.default;
  });
